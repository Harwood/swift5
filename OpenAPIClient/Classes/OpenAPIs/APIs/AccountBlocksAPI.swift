...
open class AccountBlocksAPI {
     ...
     */
    @discardableResult
    open class func apiV1ServerBlocklistAccountsAccountNameDelete(accountName: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
        return apiV1ServerBlocklistAccountsAccountNameDeleteWithRequestBuilder(accountName: accountName).execute(apiResponseQueue) { result in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
     ...
     */
    open class func apiV1ServerBlocklistAccountsAccountNameDeleteWithRequestBuilder(accountName: String) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    open class func apiV1ServerBlocklistAccountsGet(start: Int? = nil, count: Int? = nil, sort: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
        return apiV1ServerBlocklistAccountsGetWithRequestBuilder(start: start, count: count, sort: sort).execute(apiResponseQueue) { result in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func apiV1ServerBlocklistAccountsGetWithRequestBuilder(start: Int? = nil, count: Int? = nil, sort: String? = nil) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    open class func apiV1ServerBlocklistAccountsPost(apiV1ServerBlocklistAccountsPostRequest: ApiV1ServerBlocklistAccountsPostRequest? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
        return apiV1ServerBlocklistAccountsPostWithRequestBuilder(apiV1ServerBlocklistAccountsPostRequest: apiV1ServerBlocklistAccountsPostRequest).execute(apiResponseQueue) { result in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func apiV1ServerBlocklistAccountsPostWithRequestBuilder(apiV1ServerBlocklistAccountsPostRequest: ApiV1ServerBlocklistAccountsPostRequest? = nil) -> RequestBuilder<Void> {
        let localVariablePath = "/api/v1/server/blocklist/accounts"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: apiV1ServerBlocklistAccountsPostRequest)
