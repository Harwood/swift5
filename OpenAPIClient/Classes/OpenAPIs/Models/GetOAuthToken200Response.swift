...
public struct GetOAuthToken200Response: Codable, JSONEncodable, Hashable {

    static let expiresInRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    static let refreshTokenExpiresInRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
