...
public struct Abuse: Codable, JSONEncodable, Hashable {
    ...
    static let reasonRule = StringRule(minLength: 2, maxLength: 3000, pattern: nil)
    static let moderationCommentRule = StringRule(minLength: 2, maxLength: 3000, pattern: nil)
    public var id: Int?
