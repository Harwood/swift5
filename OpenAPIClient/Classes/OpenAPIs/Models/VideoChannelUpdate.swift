...
public struct VideoChannelUpdate: Codable, JSONEncodable, Hashable {
    ...
    public init(displayName: AnyCodable? = nil, description: AnyCodable? = nil, support: AnyCodable? = nil, bulkVideosSupportUpdate: Bool? = nil) {
