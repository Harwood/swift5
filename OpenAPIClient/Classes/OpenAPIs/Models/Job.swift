...
public struct Job: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, state: State? = nil, type: ModelType? = nil, data: [String: AnyCodable]? = nil, error: [String: AnyCodable]? = nil, createdAt: Date? = nil, finishedOn: Date? = nil, processedOn: Date? = nil) {
        self.id = id
        self.state = state
        self.type = type
        self.data = data
