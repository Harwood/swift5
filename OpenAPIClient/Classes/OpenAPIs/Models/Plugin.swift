...
public struct Plugin: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, type: ModelType? = nil, latestVersion: String? = nil, version: String? = nil, enabled: Bool? = nil, uninstalled: Bool? = nil, peertubeEngine: String? = nil, description: String? = nil, homepage: String? = nil, settings: [String: AnyCodable]? = nil, createdAt: Date? = nil, updatedAt: Date? = nil) {
        self.name = name
        self.type = type
