...
public struct Account: Codable, JSONEncodable, Hashable {
    ...
    static let displayNameRule = StringRule(minLength: 3, maxLength: 120, pattern: nil)
    public var id: Int?
    ...
    public init(id: Int? = nil, url: String? = nil, name: String? = nil, host: String? = nil, hostRedundancyAllowed: Bool? = nil, followingCount: Int? = nil, followersCount: Int? = nil, createdAt: Date? = nil, updatedAt: Date? = nil, userId: AnyCodable? = nil, displayName: String? = nil, description: String? = nil) {
        self.id = id
        self.url = url
        self.name = name
        self.host = host
